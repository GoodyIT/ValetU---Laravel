...
<!-- Hidden Fields -->
        ...
        <div class="form-group">
            <input id="input-city" type="text" class="form-control  city" name="city" v-model="formInputs.city" >
            <span v-if="formErrors['city']" class="error">{{ formErrors['city'] }}</span>
        </div>
            
        <div class="form-group">
        <input id="input-state" type="text" class="form-control state" name="state" v-model="formInputs.state" >
        <div v-if="formErrors['state']" class="help-block with-errors">{{ formErrors['state'] }}</div>
        </div>
        
        <div class="form-group">
        <input id="input-zipcode" v-model="formInputs.zipcode" type="text" class="form-control zipcode" name="zipcode">
        <div v-if="formErrors['zipcode']" class="help-block with-errors">{{ formErrors['zipcode'] }}</div>
        </div>
        
        <div class="form-group">
        <input id="input-country" type="text" class="form-control country" name="country" v-model="formInputs.country" >
        <div v-if="formErrors['country']" class="help-block with-errors">{{ formErrors['country'] }}</div>
        </div>
        
        <div class="form-group">
        <input id="input-latitude" type="text" class="form-control latitude" name="latitude" v-model="formInputs.latitude" >
