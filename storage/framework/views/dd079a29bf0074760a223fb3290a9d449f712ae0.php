  ...
  <div class="site-index">
    ...
    <div class="card">
        <div class="card-body clearfix">
          ...
          <?php echo $__env->make('home.valid', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            ...
            <div class="pmbb-body">
              <div class="pmbb-view">
                ...
                <div id="parking-table">  
                  <?php echo $__env->make('parking', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
              </div>
            </div>
        </div>
